    ...
    <div>
      ...
      <Router>
        <Routes>
            ...
            <Route path="/newProject" element={<Newproject data={data} setData={setData} projects={projects} />} />
            ...
            <Route path="/project/:projectid" element={<Project  project={project} setProject={setProject} risks={risks} setRisks={setRisks} setProjects={setProjects} user={user} setUser={setUser} />} />
